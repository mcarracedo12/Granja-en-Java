...
VALUES(0, 0, '1900-01-01','Comprador Generico');
INSERT INTO GRANJA(ID, DINERO_EN_CAJA, ULTIMA_ACTUALIZACION, NOMBRE)
...
INSERT INTO TIPOS_ANIMALES (ID,  ANIMAL, IMAGEN,  CANTIDAD_MAXIMA,  DIAS_EXPIRACION, TIEMPO_DE_REPRODUCCION, PRECIO_COMPRA, PRECIO_VENTA, GRANJA_ID)
VALUES(5, 'HUEVO', '../assets/huevo.jpg', 10000, 21, 21, 10, 20, 0);

--INSERT INTO ANIMAL (DTYPE, ID, EDAD_EN_DIAS_AL_INGRESAR, FECHA_INGRESOAGRANJA, GRANJA_ID, TIPOS_ANIMAL_ID, PRECIO_COMPRA, PRECIO_VENTA)
--VALUES ('HUEVO', 1, 5, '2023-02-02', 1, 1, 0, 0);
